...
public class Operations {
    ...
    public static abstract class Quantor extends Expression {
        ...
        Quantor(Variable variable, Expression expression) {
    ...
    public static class Add extends Binary {
        ...
        public Expression getInstance() {
            return new Add(left.getInstance(), right.getInstance());
        }
    ...
    public static class And extends Binary {
        ...
        public Expression getInstance() {
            return new And(left.getInstance(), right.getInstance());
        }
    ...
    public static class Any extends Quantor {
        ...
        public Expression getInstance() {
            return new Any((Variable) variable.getInstance(),
    ...
    public static class Exist extends Quantor {
        ...
        public Expression getInstance() {
            return new Exist((Variable) variable.getInstance(),
                    expression.getInstance());
        }
    ...
    public static class Equal extends Binary {
        ...
        public Expression getInstance() {
            return new Equal(left.getInstance(), right.getInstance());
        }
    ...
    public static class Implication extends Binary {
        ...
        public Expression getInstance() {
            return new Implication(left.getInstance(), right.getInstance());
        }
    ...
    public static class Increment extends Unary {
        ...
        public Expression getInstance() {
            return new Increment(left.getInstance());
        }
    ...
    public static class Multiply extends Binary {
        ...
        public Expression getInstance() {
            return new Multiply(left.getInstance(), right.getInstance());
        }
    ...
    public static class Not extends Unary {
        ...
        public Expression getInstance() {
            return new Not(left.getInstance());
        }
    ...
    public static class Or extends Binary {
        ...
        public Expression getInstance() {
            return new Or(left.getInstance(), right.getInstance());
        }
